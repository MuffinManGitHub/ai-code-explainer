  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-between p-24 bg-gradient-to-r from-blue-500 to-purple-500 h-32 w-full">
      <main className="flex flex-col items-center justify-between p-24">
        ...
        <textarea className="border-2 border-black p-2 rounded bg-white" placeholder="Enter your code here..."></textarea>
        <button className="bg-blue-500 text-white p-2 m-2 rounded hover:bg-blue-800">Submit</button>
        <div className="border-2 border-black p-2 rounded bg-white">AI response section</div>
      </main>
    </div>
  );
}
